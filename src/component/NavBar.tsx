...
export function NavBar() {
  ...
  return (
    <div className="navbar glass-card sticky top-0 z-50 shadow-lg">
        ...
        <div className="flex-none gap-2">
          <ul className="menu menu-horizontal px-1 gap-1">
            <li>
              <Link
                to="/polls"
                className="font-medium hover:bg-primary/10 rounded-lg"
              >
                Polls
              </Link>
            </li>
            <li>
              <Link
                to="/polls/create"
                className="btn btn-sm btn-gradient font-medium"
              >
                + Create Poll
              </Link>
            </li>
